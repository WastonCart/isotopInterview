...
public class Abi extends Contract {
    ...
    public RemoteFunctionCall<TransactionReceipt> mint(String _to, BigInteger tokenId) {
        final Function function = new Function(
                FUNC_mint, 
    ...
    public RemoteFunctionCall<TransactionReceipt> safeMint(String _to) {
        final Function function = new Function(
                FUNC_safeMint, 
                Arrays.<Type>asList(new Address(160, _to)),
                Collections.<TypeReference<?>>emptyList());
    ...
    public RemoteFunctionCall<TransactionReceipt> safeMint(String _to, BigInteger tokenId) {
        final Function function = new Function(
                FUNC_safeMint, 
                Arrays.<Type>asList(new Address(160, _to),
                new Uint256(tokenId)),
    ...
    public RemoteFunctionCall<Tuple2<BigInteger, List<BigInteger>>> tokens(BigInteger offset, BigInteger limit) {
    ...
    public RemoteFunctionCall<Tuple2<BigInteger, List<BigInteger>>> tokensOf(String owner, BigInteger offset, BigInteger limit) {
